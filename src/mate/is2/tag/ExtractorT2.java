...
final public class ExtractorT2 extends PipeGen implements IPipe  {
	...
	/* (non-Javadoc)
	 * @see mate.is2.tag5.IPipe#createInstances(java.lang.String, java.io.File, mate.is2.data.InstancesTagger)
	 */
	...
	/* (non-Javadoc)
	 * @see mate.is2.tag5.IPipe#initValues()
	 */
	...
	/* (non-Javadoc)
	 * @see mate.is2.tag5.IPipe#initFeatures()
	 */
	...
	/* (non-Javadoc)
	 * @see mate.is2.tag5.IPipe#write(java.io.DataOutputStream)
	 */
	@Override
