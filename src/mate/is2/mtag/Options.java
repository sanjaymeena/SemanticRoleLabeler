...
public final class Options extends OptionsSuper {
	...
	private void explain() {
		...
		System.out.println("java -cp anna.jar mate.is2.mtag.Tagger [Options]");
		System.out.println();
		System.out.println("Example: ");
		System.out.println(" java -cp mate.jar mate.is2.mtag.Tagger -model eps3.model -train corpora/conll08st/train/train.closed -test corpora/conll08st/devel/devel.closed  -out b3.test -eval corpora/conll08st/devel/devel.closed  -count 2000 -i 6");
		System.out.println("");
