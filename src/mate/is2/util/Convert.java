...
import mate.is2.io.CONLLReader06;
import mate.is2.io.CONLLReader08;
import mate.is2.io.CONLLReader09;
import mate.is2.io.CONLLWriter06;
...
public class Convert {
	...
	public static void main(String args[]) throws Exception {
		...
		if (args.length<2) {
			...
			System.out.println(" java mate.is2.util.Convert <in> <out> [-w06|-w0809|-yue]  [-wordsonly]");
