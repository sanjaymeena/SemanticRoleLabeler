...
public class ParserEvaluator2 {
	...
	public static void main(String args[]) throws Exception{
		...
		String data1="data/srl-emotibot-train_conll.txt";
		String data2="data/srl-emotibot-train_conll2.txt";
		Results r=evaluate(data1, data2);
