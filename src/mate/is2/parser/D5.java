 ...
 * 
 */
package mate.is2.parser;

import mate.is2.data.DX;
...
final public class D5 extends DX {
	...
	/* (non-Javadoc)
	 * @see mate.is2.parser52L.DX#clean()
	 */
	...
	/* (non-Javadoc)
	 * @see mate.is2.parser52L.DX#cs(int, int)
	 */
	...
	/* (non-Javadoc)
	 * @see mate.is2.parser52L.DX#csa(int, int)
	 */
	...
	/* (non-Javadoc)
	 * @see mate.is2.parser52L.DX#csa(int, int, mate.is2.data.IFV)
	 */
	...
	/* (non-Javadoc)
	 * @see mate.is2.parser52L.DX#getVal()
	 */
	public long getVal() {
		if (h<0) {
	...
	/* (non-Javadoc)
	 * @see mate.is2.parser52L.DX#map(mate.is2.data.IFV, long)
	 */
	...
	/* (non-Javadoc)
	 * @see mate.is2.data.DX#computeLabeValue(short, short)
	 */
	@Override
