...
import mate.is2.parser.Options;
...
public class Pipeline {
	...
	public static void main(String[] args) throws IOException {
		...
		mate.is2.lemmatizer.Options optsLemmatizer = new mate.is2.lemmatizer.Options(new String[] {"-model","models/lemma-eng.model"});
		...
		mate.is2.tag.Options optsTagger = new mate.is2.tag.Options(new String[]{"-model","models/tag-eng.model"});
...
//		i.setPPos(pos);
		...
		mate.is2.io.CONLLWriter09 writer = new mate.is2.io.CONLLWriter09("example-out.txt");
